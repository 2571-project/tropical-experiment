...
Our setting will be using the following notation throughout.
Let $T$ be the set $\NN \cup \{\epsilon\}$.
Let $\oplus$ be the operation on $T$ defined by $a \oplus b = \max\{a,b\}$.
Let $\otimes$ be the operation on $T$ defined by $a \otimes b = a + b$.
We shall refer to $(T,\oplus,\otimes)$ as the tropical semiring of the nonnegative natural numbers.
